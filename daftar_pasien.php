...
?>
	...
	<div id="home">
		...
		<div id="content">
			<div class="fp_box5">
				<a href="tambah_pasien.php"><img src="images/add_user.png" width="130px" height ="100px" /></a>
				<h2><a href="tambah_user.php">Pasien BPJS</a></h2>
			</div>
			<div class="fp_box5">
				<a href="tambah_pasien_2.php"><img src="images/user_edit.png" width="130px" height ="100px"/></a>
				<h2><a href="lihat_user.php">Pasien Non-BPJS</a></h2>
			</div>
		</div>
		<?php
			}
		...
		<div id="permohonan2">
			<div class="fp_box5">
				<a href="lihat_permohonan.php"><img src="images/account-edit.png" width="110px" height="80px"/></a>
				<h2><a href="lihat_user.php">Lihat Daftar Pasien</a></h2>
			</div>
		</div>
		<?php
			}
