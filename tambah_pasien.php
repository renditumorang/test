...
?>
	...
	<div id="tambah_permohonan">
		<h3>Registrasi Pasien BPJS</h3>
		<div id="container1">
		<hr color ="#d1d4d3" size=1 width="95%" align="left"><br>
		<form method="post" action="insert_data.php" name="form" onsubmit = "return cekForm()">
			<fieldset>
				<dl>
					<dt><label>No. BPJS</label></dt>
					<dt id="a">:</dt>
					<dd><input type="text" name="no_bpjs" size="30"></dd>
				</dl>
				<dl>
					<dt><label>No. Rekam Medis</label></dt>
					<dt id="a">:</dt>
					<dd><input type="text" name="no_rm" size="30"></dd>
				</dl>
				<dl>
				...
				<dl>
					...
					<dt id="a">:</dt>
					<dd><input type="text" name="no_telp" size="30"></dd>
				</dl>
				<dl>
